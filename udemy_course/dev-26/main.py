...
# For example, we say that the key for this dictionary will be the name of the name list,
# the value will be a random number, then we iterate every name from the list.
